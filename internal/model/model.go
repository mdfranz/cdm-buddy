...
var AssetEntryLabels = map[string]string{
	"Devices":      "a device group or platform",
	"Networks":     "a network segment or path",
	"Applications": "an application",
	"Data":         "a data store or dataset",
	"Users":        "a user group or identity set",
	"Services":     "a service",
}

var AssetInstanceExamples = map[string]string{
	"Devices":      "Workstations, Build Servers, MacBooks",
	"Networks":     "Corp LAN, Prod VPC, VPN Gateway",
	"Applications": "Customer Portal, Admin Console, Mobile API",
	"Data":         "Customer DB, S3 Backups, Source Repo",
	"Users":        "Employees, Contractors, Privileged Admins",
	"Services":     "Salesforce, Atlassian, ServiceNow",
}
